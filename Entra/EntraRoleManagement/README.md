# 📘 README — Entra Role Management Scripts
...
```powershell
.\Get-UserRoles.ps1 -UserPrincipalName "GaryMcGaryface@domain.org"
```
...
│  ROLE ID: 62e90394-69a5-e237-9190-012177145e10 │
└────────────────────────────────────────────────┘
```
...
├── README.md
└── Reports/
       └── UserRoleRemoval-<username>-<timestamp>.html
```

---

## 🛑 Permissions — Understanding 403 Errors
...
## 🔐 Required Entra Roles to Remove Role Assignments
...
| **Privileged Role Administrator (PRA)** | ✔ Yes |
| **Role Management Administrator** | ✔ Yes |
| User Administrator | ❌ No |
| Cloud App Administrator | ❌ No |
| Security Reader | ❌ No |
...
## 🛠️ Fixing Permissions

### ✔ Option 1 — Activate PIM
...
### ✔ Option 2 — Sign in as a Global Administrator
...
### ✔ Option 3 — Assign “Role Management Administrator”
...
<b>Role ID:</b> 158c047a-c207-445e-b76f-4fe554a6a5f7<br>
...
| No roles returned | User has no active role assignments | Verify in Entra portal under **Roles and administrators → Directory roles** |
